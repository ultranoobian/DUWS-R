...
if (revive_activated == 2) then {[_soldier1] execvm 'ais_injury\init_ais.sqf';}; //adding AIS Revive to each soldier
...
if (revive_activated == 2) then {[_soldier2] execvm 'ais_injury\init_ais.sqf';}; //adding AIS Revive to each soldier
...
if (revive_activated == 2) then {[_soldier3] execvm 'ais_injury\init_ais.sqf';}; //adding AIS Revive to each soldier etc
